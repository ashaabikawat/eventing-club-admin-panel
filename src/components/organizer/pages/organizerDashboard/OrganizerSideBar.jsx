...
const OrganizerSideBar = () => {
  ...
  const handleLogout = () => {
    ...
    dispatch(setOrganizerSignupData(null));
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-Gray85">
          ...
          <ul className="space-y-2 font-medium">
            ...
            <NavLink to={"/organizer/dashboard/event"}>
              <li>
                <button
                  type="button"
            ...
            <NavLink to={`/organizer/dashboard/booking`}>
              <li>
                <button
                  type="button"
            ...
            <NavLink to={"/organizer/dashboard/reports"}>
              <li>
                <button
                  type="button"
                  className="px-5 flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 "
            ...
            <NavLink to={"/organizer/dashboard/settings"}>
              <li>
                <button
                  type="button"
                  className="px-5 flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 "
