...
const AllPendingReviewEventData = () => {
  ...
  const getALLEventData = async () => {
    try {
      ...
      const FetchEventData = await axios.post(
        `${eventEndPoint.GET_TBR_EVENTS_PAGINATION}`,
        payload
      );
  ...
  return (
    <>
      ...
      <div className="w-full mt-8 md:mt:0 border-b-2 pb-4 border-Gray85">
...
export default AllPendingReviewEventData;
