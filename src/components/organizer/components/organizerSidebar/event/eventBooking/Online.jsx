...
const Online = ({
  ...
  return (
    <>
      <div className="mt-4 md:ml-6">
        ...
        <div className="flex  md:flex-row  gap-2 flex-col md:gap-10 mb-10 ">
          {selectedBookingType === 2 && (
            <div className="flex mt-8  items-end gap-x-6 md:gap-x-11 mx-auto ">
              {tabs.map((event) => (
                <div key={event.id}>
                  <button
            ...
            <div className="flex md:mt-0 mt-4 gap-x-4">
              ...
              <div className="relative inline-block text-left">
                ...
                {isOpen && (
                  <div
                    id="dropdown"
                    className="z-10 absolute -right-10 md:right-0 mt-2 w-44  bg-white  divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700"
                  >
                    <ul
      ...
      <div className="w-[100%] mt-8 mx-auto border-b-2 pb-4 border-Gray85">
