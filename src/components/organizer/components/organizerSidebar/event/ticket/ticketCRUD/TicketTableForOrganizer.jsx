...
// const TicketTableForOrganizer = ({
//   eventTicketsData: initialEventTicketsData,
// }) => {
//   const { _id } = useParams();
...
//     navigate(`/organizer/dashboard/event/editticket/${eventId}/${ticketId}`);
//   };
...
//                   ticketData.EventTicketStatus === TicketAvailability.SoldOut
//                     ? "bg-red-700"
//                     : ""
//                 }`}
//               >
...
//                     <div className="absolute w-48 right-[78%] top-[10%] bg-white border border-gray-300 rounded-md shadow-lg">
//                       <div className="py-1">
//                         <button
...
// export default TicketTableForOrganizer;
            ...
            {eventTicketsData.map((ticketData, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="w-20 py-4 pl-4 md:pl-0">
                    {ticketData?.TicketDate
                      ? new Date(ticketData.TicketDate).toLocaleDateString(
                          "en-GB",
                          {
