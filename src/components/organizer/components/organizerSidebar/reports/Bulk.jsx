    ...
    <div>
      ...
      <div className=" mt-[2%] w-full justify-end ">
        ...
        {selectedBookingType === 2 && (
          <div className="flex mt-8 gap-6 md:gap-x-11 w-[100%] mx-auto">
            {tabs.map((event) => (
              <div key={event.id}>
                <button
        ...
        <div className="w-full md:mt-0 mt-4  flex justify-end">
        ...
        <div className="flex md:flex-row flex-col my-6 gap-4 w-[100%]">
