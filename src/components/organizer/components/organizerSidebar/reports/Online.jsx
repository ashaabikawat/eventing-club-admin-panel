  ...
  return (
    <>
      <div className="mt-4">
        ...
        <div className="w-[100%]  ">
          <div className="w-[100%]  mt-12 md:flex-row flex-col  gap-4 md:items-end md:gap-20  flex justify-betweenn">
      ...
      <div className="w-[100%] mx-auto border-b-2 md:mt-0 mt-8 pb-4 border-Gray85">
