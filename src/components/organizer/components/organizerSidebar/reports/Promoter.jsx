...
const Promoter = ({
  ...
  return (
    <>
      <div className="mt-4">
          ...
          <div className="w-[100%] mt-12 md:items-end  md:flex-row flex-col  gap-4 md:gap-20  flex justify-between">
            <div className="relative flex items-center md:w-[50%] h-12 rounded-lg focus-within:shadow-lg bg-white overflow-hidden border border-black ">
              <div className="grid place-items-center h-full w-12 text-gray-300">
                <svg
                  xmlns="htt0p://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
        ...
        {selectedBookingType === 2 && (
          <div className="flex  md:flex-row flex-col md:gap-0 gap-4  md:items-center justify-center mt-6">
            <div className="flex mt-8 md:gap-x-11 gap-x-6 w-[100%] mx-auto">
              {tabs.map((event) => (
                <div key={event.id}>
                  <button
      ...
      <div className="w-[100%] relative mx-auto md:mt-0 mt-8 border-b-2 pb-4 border-Gray85">
