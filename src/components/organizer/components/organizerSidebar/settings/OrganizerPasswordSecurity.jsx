...
const OrganizerPasswordSecurity = () => {
      ...
      onSubmit: async (values) => {
        ...
        try {
          let response = await axios.post(
            `${organizerEndpoint.PROFILE_CHANGE_PASSWORD}`,
            palyload
          );
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="">
          ...
          <div className="mb-4">
            ...
            <div className="relative mt-1.5 ">
              <input
                ...
                className="md:w-[70%] w-[80%] p-2 border border-gray-300 rounded"
              ...
              <span
                className="absolute inset-y-0 md:right-[32%] right-[24%]  flex items-center cursor-pointer"
        ...
        <div className="w-[70%] flex md:justify-end mt-5">
...
export default OrganizerPasswordSecurity;
