...
import { authendpoints, promoterEndPointPannel } from "../../../services/apis";
import { useDispatch } from "react-redux";
import { setadminSignupData } from "../../../slices/authSlice";
import { Link, useNavigate } from "react-router-dom";
import { setOrganizerSignupData } from "../../../slices/organizerAuthSlice";
import { setPromoterSignupData } from "../../../slices/promoterAuthSlice";
import { loginObjectSchema } from "../../superAdmin/validation/YupValidation";
...
const PromoterLogin = () => {
      ...
      onSubmit: async (values) => {
        ...
        try {
          let response = await axios.post(
            `${promoterEndPointPannel.LOGIN_PROMOTER_URL}`,
            palyload
          );

          console.log(response.data);
          toast.success(response.data.message);
          dispatch(setPromoterSignupData(response.data.data));
          localStorage.setItem("promotertoken", response.data.data.token);
  ...
  return (
    <div className="w-full h-full flex">
      <Toaster />
      <div className="bg-Gray85 w-[45%] md:block hidden h-[100vh]">
      ...
      <div className="md:w-[55%] w-full h-full">
        <div className="">
          ...
          >
            ...
            {/* <Link to={"/promoter-forgotpassword"}>
