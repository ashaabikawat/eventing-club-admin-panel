...
// import { forgotPasswordEmailObjectSchema } from "../validation/YupValidation";
import {  promoterEndPointPannel } from "../../../services/apis";
import { useFormik } from "formik";
import { Link } from "react-router-dom";
import axios from "axios";

const PromoterForgotPassword = () => {
      ...
      onSubmit: async (values) => {
        ...
        try {
          let response = await axios.post(
            `${promoterEndPointPannel.PROMOTER_FORGOT_PASSWORD_SEND_EMAIL}`,
            palyload
          );
...
export default PromoterForgotPassword