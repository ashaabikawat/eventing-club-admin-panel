...
import { dropdownOptions } from "../event/modalCrationData/modalOpen";
import { dateFilter } from "../../../../common/datefilter";
  ...
  return (
    <>
      <div className="mt-4">
        ...
        <div className="w-[100%]  ">
          <div className="w-[100%]  mt-12 md:flex-row flex-col md:items-end md:gap-20 gap-6  flex justify-betweenn">
        ...
        {selectedBookingType === 2 && (
          <div className="flex  md:flex-row flex-col md:items-center md:gap-0 gap-4 justify-center mt-6">
            <div className="flex mt-8 md:gap-x-11 w-[100%] gap-x-6  mx-auto">
              {tabs.map((event) => (
                <div key={event.id}>
                  <button
      ...
      <div className="w-[100%] mx-auto border-b-2 pb-4 md:mt-0 mt-8 border-Gray85">
                ...
                {allBookingData?.length >= 1 ? (
                  allBookingData?.map((eventData, index) => (
                    ...
                    >
                      ...
                      <td className=" pl-10 py-4">{eventData.Email}</td>
