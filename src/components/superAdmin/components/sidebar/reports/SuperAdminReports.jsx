...
const SuperAdminReports = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const payload = {
          ...
          user_id: adminuser.adminSignupData.user_id,
          event_id: eventData._id,
          // searchKeyword: debouncedSearchTerm.replace(/\s+/g, " ").trim(),
  ...
  const handleBookingClick = async (bookingTitleId) => {
    setActiveBooking(bookingTitleId);

    // switch (bookingTitleId) {
    //   case 1:
    ...
    //     break;
    //   case 3:
    //     await fetchPromoterBookings();
    //     break;
    //   case 4:
    //     await fetchBulkTicketBookings();
    //     break;
    //   default:
    //     setAllTransactionBookingData([]);
    // }
  };
  ...
  return (
    <div className="mt-[3%] ml-[2%] min-h-screen">
        ...
        {selectedBookingType === 1 && (
          <div>
            <button
              ...
              className="bg-[#666666] md:w-56 text-white py-2 md:px-4 px-2 rounded"
            >
              Download Report{" "}
            </button>
          </div>
      ...
      <div>
        {selectedBookingType === 1 && (
          <div className="w-full md:flex-row flex-col flex md:items-center mt-12 ">
            <div className=" flex  gap-4 md:w-[50%]">
              <div className="relative md:w-[40%] text-center mt-[3%]">
                <button
                  id="dropdownDelayButton"
                  onClick={toggleDropdownName}
                  className="text-Gray40 w-full md:px-6 py-2 px-2  focus:ring-1 focus:outline-none focus:ring-Gray40 font-medium rounded-lg md:text-lg  text-center inline-flex items-center border border-Gray40"
                  type="button"
                >
                  <span>
                    <CiFilter size={22} />
              ...
              <div className="relative md:w-[40%] text-center mt-[3%]">
                <button
                  id="dropdownDelayButton"
                  onClick={toggleDropdown}
                  className="text-Gray40 w-full md:px-6 px-4 py-2 focus:ring-1 focus:outline-none focus:ring-Gray40 font-medium rounded-lg md:text-lg  text-center inline-flex items-center border border-Gray40"
                  type="button"
                >
                  <span>
                    <CiFilter size={22} />
