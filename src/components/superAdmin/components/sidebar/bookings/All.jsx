...
const All = ({ setSelectedEventType, selectedEventType }) => {
  ...
  const getAllPublishedEventNames = async () => {
    ...
    try {
      ...
      // console.log("published ", FetchEventData.data.data);
  ...
  // console.log("totalpage", originalTotalPage);
  // console.log("count", count);
  // console.log("bookingdata", allBookingData);
      ...
      <div className="mt-10 md:ml-6">
        ...
        <div className="w-[94%]">
          <div className="flex justify-between items-center">
            <h1 className="md:text-4xl text-2xl mt-10 mb-6 font-bold text-black">
              Bookings
            </h1>
          ...
          <div className="w-[100%]  flex gap-4 flex-col justify-between">
            <div className="relative flex items-center w-full md:w-[50%] h-12 rounded-lg focus-within:shadow-lg bg-white overflow-hidden border border-black ">
        ...
        <div className="flex mt-8 gap-x-11 w-[100%] ">
          {tabs.map((event) => (
            <div key={event.id}>
              <button
