...
const Promoter = ({
  ...
  return (
    <>
      <div className="mt-4 md:ml-6">
        ...
        <div className="flex md:flex-row  gap-2 flex-col md:gap-10 mb-10 ">
          {selectedBookingType === 2 && (
            <div className="flex items-end mt-8 gap-x-11  mx-auto ">
              {tabs.map((event) => (
                <div key={event.id}>
                  <button
          ...
          <div className="flex md:flex-row  md:mt-0 mt-4 flex-col gap-4 w-[100%]">
        ...
        <div className="w-[94%]  ">
          <div className="w-[100%] gap-4 flex-col flex justify-between">
            ...
            <div className="flex md:mt-0 mt-4  gap-x-4">
              <div onClick={openEventFilterPopUp}>
        ...
        {openFilteredPop && (
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-30 flex items-center justify-center z-50 overflow-y-auto">
            <div className="bg-white p-4 rounded-md md:w-[60%] lg:w-[50%] w-[80%]">
              ...
              <div className="">
                 ...
                 */}
                <div className="md:flex w-full mt-4 gap-x-5 ">
                  {/* <div className="w-[50%]">
                  ...
                  <div className="md:w-[50%]">
                    ...
                    <Select
                      ...
                      options={promoters.map((promoters) => ({
                        value: promoters.promoter_id,
                        label: promoters.PromoterUsername,
                      }))}
              ...
              <div className="w-full flex md:justify-end gap-x-4">
                <button
                  className="mt-4 md:w-[25%] border-2 border-Gray40  text-black p-2 rounded-md"
                  onClick={() => setOpenFilteredPop(false)}
                >
                  Close
                </button>
                <button
                  className="mt-4 md:w-[25%] bg-Gray40 text-white p-2 rounded-md"
      ...
      <div className="w-[100%] mx-auto md:mt-0 mt-6 border-b-2 pb-4 border-Gray85">
