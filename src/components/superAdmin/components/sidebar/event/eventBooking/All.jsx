...
const All = ({
  ...
  const getBookingData = async () => {
    ...
    try {
      ...
      toast.success(fetchBooking.data.message);
    ...
    <>
      <div className="mt-4 md:ml-6 ">
        ...
        {selectedBookingType === 2 && (
          <div className="flex mt-8 md:gap-x-11  w-[100%] mx-auto mb-8">
            {tabs.map((event) => (
              <div key={event.id}>
                <button
            ...
            <div className="flex justify-end w-full">
              <button
                ...
                } bg-[#666666]  md:w-56 text-white py-2 md:px-4 px-2 rounded`}
      ...
      <div className="w-[100%] mx-auto md:mt-0 mt-8 border-b-2 pb-4 border-Gray85">
                ...
                {allBookingData?.length >= 1 ? (
                  allBookingData?.map((eventData, index) => (
                    ...
                    >
                      ...
                      <td className="pl-8 py-4">{eventData.PromoterName}</td>
                      ...
                      <td className="pl-7 py-4">{eventData.TicketPrice}</td>
