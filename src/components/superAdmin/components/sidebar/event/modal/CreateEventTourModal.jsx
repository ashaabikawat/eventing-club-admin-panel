...
const CreateEventTourModal = ({
  setShowCreateEventTourModal,
  onNewEventTour,
}) => {
  ...
  const {
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        onNewEventTour(response.data.data);
        resetForm();
        setImages([]);
        setShowCreateEventTourModal(false);
      } catch (error) {
        if (error.response) {
      ...
      <div className="bg-white p-4  rounded-md  md:w-[50%]">
        <div className="mt-[10%]">
          ...
          <div className="w-[96%] flex justify-between">
            ...
            >
              <FaWindowClose size={30} className="mt-24" />
            </p>
          </div>
          ...
          >
            ...
            <div className="w-[97%]  flex justify-end items-end ">
              <button
...
export default CreateEventTourModal;
