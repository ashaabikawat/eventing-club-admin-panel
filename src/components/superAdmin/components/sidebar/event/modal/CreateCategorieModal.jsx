...
const CreateCategorieModal = ({
  onNewCategorie,
  setShowCreateCategorieModal,
}) => {
  ...
  const {
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        resetForm();
        setImages([]);
        setShowCreateCategorieModal(false);
      } catch (error) {
        if (error.response) {
      ...
      <div className="bg-white p-4  rounded-md  md:w-[50%]">
        <div className="mt-[42%]">
          ...
          <div className="w-[100%] flex justify-between ">
            <p className="text-3xl pl-2 text-black font-bold mb-6">
              Create Category
            </p>
          ...
          >
            <div className="w-[96%] mx-auto h-[500px] bg-grayshade mt-[1%]">
...
export default CreateCategorieModal;
