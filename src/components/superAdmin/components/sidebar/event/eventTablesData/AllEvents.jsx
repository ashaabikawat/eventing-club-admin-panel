...
const AllEvents = () => {
  ...
  const getALLEventData = async () => {
    ...
    try {
      const FetchEventData = await axios.post(
        `${eventEndPoint.GET_ALL_PAGINATION}`,
        payload
      );

      console.log("response ===>", FetchEventData.data.data);
  ...
  //         `${`${eventEndPoint.GET_ALL_EVENTS_DATA_BY_ADMIN}`}`,
  //         payload
  //       );
  ...
  return (
    <div>
          ...
          <div className="flex   md:mt-0 mt-4 gap-x-4">
            ...
            <div className="relative inline-block text-left">
              <button
                ...
                className="text-semiBlack  border-[2px] border-semiBlack   font-medium rounded-lg text-sm md:px-5 md:py-3 p-2 text-center inline-flex items-center "
                type="button"
              >
                Select Date
                <BsChevronDown
      ...
      <div className="w-full border-b-2 pb-4 border-Gray85 mt-8 md:mt:0">
        <div className="relative overflow-x-auto overflow-visible shadow-md sm:rounded-lg mt-[2%]">
          {!loading && (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 relative">
                        ...
                        {openDropdownId === eventData._id && (
                          ...
                          >
                            {/* <div className="absolute right-[78%] top-[0%]  z-50 mt-2 w-48 bg-white border border-gray-300 rounded-md shadow-lg"> */}
