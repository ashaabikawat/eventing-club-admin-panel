...
import { setToken, setadminSignupData } from "../../../../slices/authSlice";
import { handleLogout } from "../../../../reducer/persistorStore/reduxstore";

const DashboardComponent = () => {
  // State to toggle the visibility of the profile section
  ...
  return (
    <div className="w-full h-auto">
      ...
      {/* Profile section */}
      {/* {openProfileSection && (
        <div className="w-[79%] flex justify-end items-end absolute z-10">
          <div
          ...
          >
            <div className="w-[90%] h-full py-[6%] mx-auto my-auto">
              ...
              <p className="text-lg pb-4 border-b-[1px] border-black border-opacity-20 pl-4">
                {adminuser?.adminSignupData?.Email}
              </p>
              ...
              <button
                className="flex justify-center items-center mt-3  pl-4"
